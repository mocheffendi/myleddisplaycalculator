...
class MyCabinetHistory extends StatefulWidget {
  ...
  @override
  State<MyCabinetHistory> createState() => _MyCabinetHistoryState();
}

class _MyCabinetHistoryState extends State<MyCabinetHistory> {
                ...
                ElevatedButton(
                    onPressed: () {
                      if (docID == null) {
                        ...
                        firestoreServiceCabinet.updateNote(
                            docID, controller.text);
                      }
                      controller.clear();
  ...
  //                 //     .addTaskLedDisplayCalculator(controller.text);
  //               } else {
  //                 firestoreServiceCabinet.updateNote(docID, controller.text);
  //               }
  //               controller.clear();
          ...
          Column(
            children: [
              StreamBuilder<QuerySnapshot>(
                stream: firestoreServiceCabinet.getNotesStream(),
